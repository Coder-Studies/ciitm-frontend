               ...
               <div className='flex items-center gap-4'>
                  ...
                  <div>
                     ...
                     <p className='text-sm text-gray-600 font-medium'>
                        ...
                        {new Set(messages.map(m => m.studentId)).size}{' '}
                        participants
                     </p>
                  </div>
               </div>
                  ...
                  return (
                     ...
                     >
                        ...
                        <div className='relative'>
                           <div
                              className={`w-12 h-12 rounded-2xl overflow-hidden shadow-lg border-2 ${
                                 isSender
                        ...
                        {/* Message Bubble */}
                        <div
                           className={`flex flex-col gap-2 max-w-[70%] ${isSender ? 'items-end' : 'items-start'}`}
                        >
                           {/* Username */}
                           <div
                              className={`text-sm font-semibold ${isSender ? 'text-blue-600' : 'text-purple-600'}`}
                           >
                           ...
                           >
                              ...
                              {/* Time indicator */}
                              <div
                                 className={`absolute bottom-2 text-xs opacity-70 ${
                                    isSender
                                       ? 'right-4 text-blue-100'
