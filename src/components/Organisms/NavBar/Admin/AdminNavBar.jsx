...
const Admin_NavBar = ({ text }) => {
   return (
      <div className='nav_bar w-screen z-30 max-[998px]:py-[2.8vh] flex justify-between fixed print:hidden items-center mb-[2vh] px-[3vw] md:relative  bg-black top-0   max-[998px]:border-b-[2px] max-[998px]:border-[#2C2C2C]'>
