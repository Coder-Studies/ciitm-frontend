...
const Student_SideBar = ({ CustomStyle }) => {
   ...
   return (
      <div
         className={`w-80 h-[87vh] print:hidden max-[900px]:hidden bg-gradient-to-br from-white/90 via-white/70 to-white/40 backdrop-blur-2xl rounded-3xl flex flex-col shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] border border-white/30 overflow-hidden relative ${CustomStyle}`}
      >
         ...
         <div className='p-8 border-b border-white/30 relative z-10'>
            <div className='flex flex-col items-center'>
               ...
               <p className='text-sm text-gray-600 font-semibold mb-3 px-4 py-1 bg-white/50 rounded-full backdrop-blur-sm'>
                  Computer Science
               </p>
               ...
               {menuItems.map(item => {
                  ...
                  return (
                     ...
                     >
                        ...
                        <span
                           className={`relative z-10 font-semibold transition-all duration-500 ${
                              isActive
                                 ? 'text-white'
